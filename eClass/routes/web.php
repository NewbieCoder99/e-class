...
Route::middleware(['web', 'IsInstalled', 'switch_languages'])->group(function () {
  ...
  Route::middleware(['web', 'is_active', 'auth', 'is_admin', 'switch_languages'])->group(function () {
    ...
    // Player Settings
    Route::get('/setting/playersetting', 'PlayerSettingController@get')->name('player.set');
    Route::post('/setting/playersetting/update', 'PlayerSettingController@update')->name('player.update');
  ...
  Route::middleware(['web', 'is_active', 'auth', 'admin_instructor', 'switch_languages'])->group(function () {
    ...
    Route::get("dropdown/dropdown", "CourseController@upload_info")->name('category.dropdown');
    Route::get("dropdown/gcat", "CourseController@gcato")->name('subcategory.gcat');
    ...
    Route::resource('course/quiztopic', 'QuizTopicController');

    Route::resource('/course/questions', 'QuizController');
